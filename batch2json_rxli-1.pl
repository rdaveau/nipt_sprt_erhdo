...
my($i, $j, $k, $fastq);
my $n = 1;
my @items = qw[ fastq gender_fetus gender_proband proband CI DPN DPNI NDP PDP HMZ HTZ SNP DIST ALPHA BETA ];
my @gender = ();
my @all_params = ();
my @new_params = ();
my @all_fastq = ();
...
print TSV join("\t", qw[ design run_id fam_id matmut gender_fetus gender_proband proband Mo Fa CI DPN DPNI NDP PDP HMZ HTZ SNP DIST ALPHA BETA target_gene analysis_id ]), "\n";
