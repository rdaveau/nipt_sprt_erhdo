...
# USAGE: perl sprt_summary-2.pl \
# 	--input-dir ~/projects/moabi/nipt/data/CF08820/sprt_summary/v2 \
# 	--input-file  ~/projects/moabi/nipt/data/CF08820/CF08820-1.tsv \
# 	--output-file ~/projects/moabi/nipt/data/CF08820/sprt_summary/v2/CF08820_sprt.tsv

my $i = 0;
my %h = ();
my($d, @d, @p);
my @sprt = qw[ #SNP4 #FWD #REV #MUA #MUB %FWD %REV PC2 NC2 PC3 NC3 CS2 CS3 BS ];
