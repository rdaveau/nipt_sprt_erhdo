...
# USAGE: perl sprt_summary_rxli-3.pl \
# 	--input-dir ~/projects/moabi/nipt/data/HM00008/sprt_summary/v3 \
# 	--input-file  ~/projects/moabi/nipt/data/HM00008/HM00008-2.tsv \
# 	--output-file ~/projects/moabi/nipt/data/HM00008/sprt_summary/v3/HM00008_sprt.tsv

my $i = 0;
my %h = ();
my($d, @d, @p);
my @sprt = qw[ #SNP4 #FWD #REV #MUX PC NC CS BS ];
